...
def check_packages():
    ...
    if (
        ...
        choice = input(
            f"\n{color.GREEN}Do you still want to continue to ATHEX SPY?{color.WHITE}     Y / N > "
        ).lower()
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to ATHEX-SPY/{screenshot_location}\n{color.WHITE}"
        )
    else:
        print(
...
def screenrecord():
    ...
    if screenrecord_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving video to ATHEX-SPY/{screenrecord_location}\n{color.WHITE}"
        )
    else:
...
def pull_file():
    ...
    if pull_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving file to ATHEX-SPY/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving data to ATHEX-SPY/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_screenshots():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Screenshots to ATHEX-SPY/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_camera():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Photos to ATHEX-SPY/{pull_location}\n{color.WHITE}"
        )
    else:
...
def update_me():
    ...
    print(f"{color.CYAN}\nPlease restart ATHEX-SPY{color.WHITE}")
    exit_ATHEX_SPY()
